...
print("""
\033[0;33m  ____  _   _    _    _   _ _____ ___  
\033[0;34m / ___|| | | |  / \  | \ | |_   _/ _ \ 
\033[0;32m \___ \| |_| | / _ \ |  \| | | || | | |
\033[0;36m  ___) |  _  |/ ___ \| |\  | | || |_| |
\033[0;35m |____/|_| |_/_/   \_\_| \_| |_| \___/


""")

print("Facebook :: https://www.facebook.com/THA.BLACK.SHADOW")

print("THIS Tools Free By BLACK SHADOW")

psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......Coded By SHANTO (BLACK SHADOW)......................OPENING.............')
...
def menu():
    ...
    print'FB OLD ID CLONING [SHANTO BLACK SHADOW]'

    print 50* '-'

    print 'Codder.  : SHANTO BLACK SHADOW'

    print 'AUTHOR   : Mehadi Hasan Shanto'

    print 'FACOfficial : https://www.facebook.com/THA.BLACK.SHADOW'

    print 'GITHUB   : https://github.com/Mehadi-Hasan-Shanto'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[SHANTO-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[SHANTO-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(SHANTO)Open After 7 Days]\x1b[0m \n'
