...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mPSYCHO PICCHI█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            print """
            \033[1;92m     Picchi-Correct
                  """
            loop = 'false'
    else:
            print "\033[1;91m☠️WRONG"
            os.system('xdg-open https://www.facebook.com/psycho.picchi')
...
def Find():
    ...
    jalan('\x1b[1;93m decrypted by\x1b[1;96m     :\x1b[1;93m PSYCHO PICCHI') 
    jalan('\x1b[1;96m Facebookx1b[1;96m   :\x1b[1;96m PSYCHO PICCHI')
    os.system('xdg-open https://www.facebook.com/psycho.picchi') 
    os.system("login")
